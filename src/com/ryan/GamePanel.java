...
public class GamePanel extends JPanel {
    ...
    {
        try {
            flag = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("Flag.png")));
            mine = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("mine.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
